...
#
**NOTICE:**
* entry.B00M is <ins>**ONLY**</ins> for use against scammer's Google Forms; the program is not intended to be leveraged against non-malicious Google Forms.
...
entry.B00M is an open source project.
